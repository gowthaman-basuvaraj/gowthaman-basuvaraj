...
- **Auto-scaling** - One algo → entire stock indices

**Tech**: Kotlin • Groovy • PostgreSQL • Redis • Zerodha API • TA4J • Vue.js
...
**Tech**: Kotlin • PostgreSQL • Javalin • React.js • WebSocket • JWT
...
Database schema → API design → frontend UX. I ship complete features.
...
![Your GitHub stats](https://github-readme-stats.vercel.app/api?username=gowthaman-basuvaraj&show_icons=true&theme=dark)
...
- **LinkedIn**: [LinkedIn](https://linkedin.com/in/gowthamanbasuvaraj)
- **Location**: India
...
_"The best code is the code that doesn't need to be deployed."_
